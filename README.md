...
However, I wanted to see if there was a better forecasting method or prediction model I could use that would yields a more accurate result. I further plan to analyze the error, and see where the differences between the two different methods lie.
